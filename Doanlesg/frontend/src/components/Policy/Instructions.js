  ...
  "huong-dan-mua-hang": {
    ...
    content: (
      <>
        ...
        <p><strong>Bước 2:</strong> Click vào sản phẩm muốn mua, màn hình sẽ hiển thị pop-up với các lựa chọn sau:</p>
        <ul>
          <li>Nếu bạn muốn tiếp tục mua hàng: Bấm vào phần <strong>“Tiếp tục mua hàng”</strong> để lựa chọn thêm sản phẩm vào giỏ hàng.</li>
        ...
        <ul>
          <li>Nếu bạn đã có tài khoản, vui lòng nhập email và mật khẩu vào mục <strong>“Đã có tài khoản”</strong>.</li>
          ...
          <li>Nếu bạn muốn mua hàng mà không cần tài khoản, hãy chọn <strong>“Đặt hàng không cần tài khoản”</strong>.</li>
        </ul>
        ...
        <p><strong>Bước 5:</strong> Kiểm tra lại toàn bộ thông tin đơn hàng, ghi chú thêm nếu cần, và bấm <strong>“Gửi đơn hàng”</strong>.</p>
...
"huong-dan-doi-tra": {
  ...
  content: (
    <>
      ...
      <ul>
        <li>Sudes Nest hỗ trợ đổi hoặc trả hàng trong vòng <strong>07 ngày</strong> kể từ ngày nhận hàng.</li>
      ...
      <ul>
        <li>Sudes Nest hỗ trợ đổi/trả <strong>miễn phí</strong> trong trường hợp giao sai hàng, thiếu hàng, hoặc lỗi do Sudes Nest hoặc đơn vị vận chuyển, và quý khách chưa ký nhận hàng.</li>
        <li>Nếu đã ký nhận nhưng phát hiện vấn đề bất thường, vui lòng liên hệ ngay bộ phận <strong>Chăm sóc khách hàng</strong> của Sudes Nest để được hỗ trợ theo quy trình xử lý khiếu nại.</li>
      </ul>
    </>
  )
},
  ...
  content: (
    <>
      ...
      <ul>
        ...
        <li><strong>Đặc quyền:</strong> Check-in tại cửa hàng để nhận thêm phần quà đặc biệt.</li>
      </ul>
      ...
      <p>
        Nếu sản phẩm gặp lỗi từ phía Sudes Nest hoặc cần đổi/trả sau thanh toán, quý khách vui lòng liên hệ Hotline: <strong>1900 6750</strong> để được hỗ trợ nhanh chóng.
      </p>
      <p>
...
"quy-dinh-bao-hanh": {
  ...
  content: (
    <>
      <h2>1. Chế độ bảo hành sản phẩm tại Sudes Nest</h2>
      <p>
...
"huong-dan-chuyen-khoan": {
  ...
  content: (
    <>
      <h2>1. Thanh toán trực tiếp tại cửa hàng</h2>
      <p>Khách hàng đến cửa hàng của Sudes Nest để thanh toán trực tiếp sẽ nhận được các ưu đãi sau:</p>
      <ul>
        <li>Nhận ưu đãi đặc biệt dành riêng cho khách tại cửa hàng</li>
        <li>Nhận quà tặng kèm hấp dẫn</li>
        <li>Check-in tại cửa hàng để tham gia các chương trình khuyến mãi</li>
      </ul>

      <h2>2. Thanh toán chuyển khoản online</h2>
      <p>Khách hàng có thể lựa chọn hình thức chuyển khoản trước khi nhận hàng:</p>
      <ul>
        <li>Chuyển khoản trực tiếp vào tài khoản của Sudes Nest theo hướng dẫn từ tư vấn viên</li>
        <li>Nhận quà tặng kèm bất kỳ khi thanh toán trước</li>
      </ul>

      <h2>3. Liên hệ khi cần hỗ trợ</h2>
      <p>
        Nếu sản phẩm có lỗi từ phía Sudes Nest hoặc phát sinh khiếu nại, đổi trả, quý khách vui lòng liên hệ qua số Hotline: <strong>1900 6750</strong> để được hỗ trợ sớm nhất.
      </p>
      <p>
