...
function Header() {
    // Thêm 'isLoading' để kiểm tra trạng thái tải dữ liệu
            ...
            <div className="top-header">
                ...
                <div className="icon-group">
                    ...
                    <div className="icon-item account-dropdown">
                        <FaUser />
                        {/* SỬA LỖI QUAN TRỌNG:
              1. Thêm điều kiện kiểm tra `isLoading`. Sẽ không hiển thị gì cho đến khi việc kiểm tra đăng nhập hoàn tất.
              2. Khi `user` tồn tại, chỉ hiển thị `user.email`, không hiển thị toàn bộ đối tượng `user`.
            */}
                        {isLoading ? (
                            <div className="icon-text">Tài khoản ▾</div> // Hiển thị mặc định trong khi tải
                        ) : user ? (
                            <>
        ...
        <footer className="footer">
            <div className="footer-columns">
                <div className="footer-column">
                    <Link to="/"><img src="/logo.png" alt="Logo Footer" /></Link>
